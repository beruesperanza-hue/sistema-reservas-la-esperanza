import { Star, Calendar, Utensils, MapPin, History } from 'lucide-react';
      ...
      <section className="relative bg-gradient-to-b from-esperanza-50 to-white py-32">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <div className="mb-8 animate-fade-in">
            <Star className="w-20 h-20 mx-auto text-esperanza-600 mb-6" fill="currentColor" />
          </div>
      ...
      <section className="py-20 bg-esperanza-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <History className="w-12 h-12 mx-auto text-esperanza-600 mb-4" />
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-lg border-l-4 border-esperanza-600">
              <h3 className="text-2xl font-serif font-bold text-esperanza-700 mb-3">Nuestro Viaje</h3>
              <p className="text-gray-700 font-body leading-relaxed">
            ...
            <div className="bg-esperanza-600 text-white p-8 rounded-lg border-l-4 border-accent-gold">
              <h3 className="text-2xl font-serif font-bold mb-3">Te Invitamos</h3>
